<template>
	<div class="modal fade" id="confirm" ref="confirm" role="dialog" aria-modal="true" @keydown.esc="close">
		<div :class="[ 'modal-dialog']" role="document">
			<div class="modal-content alert-info" style="background-color: #f5f5f5;">
				...
				<div class="modal-footer">
					<button @click="cancel" class="btn btn-danger" data-dismiss="modal">取消</button>
...
module.exports = {
	...
	watch: {
		isShow(){
			if(!this.isShow){
				closeDialog(this.$refs['confirm'])
			}
			else {
				openDialog('confirm', 'app')
			}
		},
	},
	created() {
