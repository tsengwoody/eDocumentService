...
class Command(BaseCommand):
	...
	def handle(self, *args, **options):
		root = User(username='root', email='tsengwoody.tw@gmail.com', first_name = 'demo root firstname', last_name = 'demo root lastname', is_active=True, is_superuser=True, is_staff=True, phone='1234567890', birthday='2016-01-01', is_scaner=True, is_manager=True, status=ACTIVE)
