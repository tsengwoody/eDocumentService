    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('upload_date', models.DateField(default=datetime.datetime(2016, 4, 18, 11, 52, 15, 113297, tzinfo=utc))),
                ('remark', models.CharField(max_length=255, null=True, blank=True)),
                ('guests', models.ManyToManyField(to='guest.Guest', null=True, blank=True)),
                ('scaner', models.ForeignKey(on_delete=django.db.models.deletion.SET_NULL, blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='EBook',
