    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('online', models.DateTimeField(null=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message_datetime', models.DateField(default=datetime.datetime(2016, 4, 18, 11, 52, 14, 534745, tzinfo=utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('message_datetime', models.DateField(default=datetime.datetime(2016, 4, 18, 11, 52, 14, 535550, tzinfo=utc))),
                ('content', models.CharField(max_length=1000)),
